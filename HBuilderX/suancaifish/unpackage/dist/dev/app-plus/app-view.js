...
var fE=_mz(z,'image',['mode',-1,'src',4],[],e,s,gg)
_(oD,fE)
_(xC,oD)
var cF=_n('view')
...
var cW=_n('view')
_rz(z,cW,'class',20,oR,xQ,gg)
var oX=_n('image')
_rz(z,oX,'src',21,oR,xQ,gg)
_(cW,oX)
_(oV,cW)
var lY=_n('view')
_rz(z,lY,'class',22,oR,xQ,gg)
var aZ=_n('view')
_rz(z,aZ,'class',23,oR,xQ,gg)
var t1=_oz(z,24,oR,xQ,gg)
_(aZ,t1)
_(lY,aZ)
var e2=_n('view')
_rz(z,e2,'class',25,oR,xQ,gg)
var b3=_oz(z,26,oR,xQ,gg)
_(e2,b3)
_(lY,e2)
var o4=_n('view')
_rz(z,o4,'class',27,oR,xQ,gg)
var x5=_n('view')
_rz(z,x5,'class',28,oR,xQ,gg)
var o6=_oz(z,29,oR,xQ,gg)
_(x5,o6)
_(o4,x5)
var f7=_n('view')
_rz(z,f7,'class',30,oR,xQ,gg)
_(o4,f7)
_(lY,o4)
_(oV,lY)
_(hU,oV)
...
bO.wxXCkey=2
_2z(z,16,oP,e,s,gg,bO,'row','index','index')
_(oB,eN)
var c8=_n('view')
...
var oHB=_mz(z,'input',['bindinput',41,'data-event-opts',1,'placeholder',2,'value',3],[],e,s,gg)
_(bGB,oHB)
_(aDB,bGB)
_(c8,aDB)
_(oB,c8)
...
_(o2B,o4B)
_(h1B,o2B)
var a6B=_mz(z,'view',['bindtap',68,'class',1,'data-event-opts',2],[],e,s,gg)
...
var hSC=_mz(z,'view',['bindtap',17,'class',1,'data-event-opts',2,'hoverClass',3],[],oPC,xOC,gg)
var oTC=_n('view')
_rz(z,oTC,'class',21,oPC,xOC,gg)
var cUC=_v()
_(oTC,cUC)
if(_oz(z,22,oPC,xOC,gg)){cUC.wxVkey=1
var oVC=_n('view')
_rz(z,oVC,'class',23,oPC,xOC,gg)
var lWC=_oz(z,24,oPC,xOC,gg)
_(oVC,lWC)
_(cUC,oVC)
}
var aXC=_n('image')
_rz(z,aXC,'src',25,oPC,xOC,gg)
_(oTC,aXC)
cUC.wxXCkey=1
_(hSC,oTC)
var tYC=_oz(z,26,oPC,xOC,gg)
_(hSC,tYC)
_(fQC,hSC)
return fQC
}
bMC.wxXCkey=2
_2z(z,15,oNC,e,s,gg,bMC,'row','index','name')
_(tKC,eLC)
_(b9B,tKC)
var eZC=_v()
_(b9B,eZC)
...
var c6C=_n('view')
_rz(z,c6C,'class',31,x3C,o2C,gg)
var h7C=_v()
_(c6C,h7C)
var o8C=function(o0C,c9C,lAD,gg){
var tCD=_mz(z,'view',['bindtap',36,'class',1,'data-event-opts',2,'hoverClass',3],[],o0C,c9C,gg)
var eDD=_n('view')
_rz(z,eDD,'class',40,o0C,c9C,gg)
var bED=_n('image')
_rz(z,bED,'src',41,o0C,c9C,gg)
_(eDD,bED)
_(tCD,eDD)
var oFD=_n('view')
_rz(z,oFD,'class',42,o0C,c9C,gg)
var xGD=_oz(z,43,o0C,c9C,gg)
_(oFD,xGD)
_(tCD,oFD)
var oHD=_mz(z,'image',['class',44,'src',1],[],o0C,c9C,gg)
_(tCD,oHD)
_(lAD,tCD)
return lAD
}
h7C.wxXCkey=2
_2z(z,34,o8C,x3C,o2C,gg,h7C,'li','li_i','name')
_(o4C,c6C)
return o4C
}
eZC.wxXCkey=2
_2z(z,29,b1C,e,s,gg,eZC,'list','list_i','list_i')
_(r,b9B)
return r
}
...
var bSD=_n('view')
_rz(z,bSD,'class',7,lOD,oND,gg)
var oTD=_v()
_(bSD,oTD)
if(_oz(z,8,lOD,oND,gg)){oTD.wxVkey=1
var xUD=_mz(z,'image',['class',9,'src',1],[],lOD,oND,gg)
_(oTD,xUD)
}
oTD.wxXCkey=1
_(eRD,bSD)
var oVD=_n('view')
_rz(z,oVD,'class',11,lOD,oND,gg)
var fWD=_oz(z,12,lOD,oND,gg)
_(oVD,fWD)
_(eRD,oVD)
var cXD=_n('view')
_rz(z,cXD,'class',13,lOD,oND,gg)
var hYD=_n('text')
_rz(z,hYD,'class',14,lOD,oND,gg)
var oZD=_oz(z,15,lOD,oND,gg)
_(hYD,oZD)
_(cXD,hYD)
var c1D=_n('text')
_rz(z,c1D,'class',16,lOD,oND,gg)
var o2D=_oz(z,17,lOD,oND,gg)
_(c1D,o2D)
_(cXD,c1D)
var l3D=_n('text')
_rz(z,l3D,'class',18,lOD,oND,gg)
var a4D=_oz(z,19,lOD,oND,gg)
_(l3D,a4D)
_(cXD,l3D)
_(eRD,cXD)
_(aPD,eRD)
...
oLD.wxXCkey=2
_2z(z,4,cMD,e,s,gg,oLD,'product','index','index')
_(cJD,hKD)
_(r,cJD)
return r
}
